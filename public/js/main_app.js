...
define("config/bootstrap", function(){});
...
define('jqm-config',["jquery"], function($) {
    $(document).on("mobileinit", function() {
        ...
        $('body').on('pagehide', function(event, ui) {
            $(event.target).remove()
        })
    });
    /*
